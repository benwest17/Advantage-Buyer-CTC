...
export default function App() {
  ...
  const cashToClose = useMemo(() => round2(downPayment + feeCalc.total + otherTotal - earnestMoney - taxCredit), [downPayment, feeCalc.total, otherTotal, earnestMoney, taxCredit]);
